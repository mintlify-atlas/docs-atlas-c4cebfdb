...
description: "SparkleCursor renders a ✦ particle trail in four retro colors. Respects prefers-reduced-motion and stays non-interactive via pointer-events-none."
---
