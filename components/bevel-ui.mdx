...
description: "Bevel UI classes recreate Windows 98 chrome via asymmetric borders — CSS utilities for raised containers, sunken panels, and clickable bevel buttons."
---
