...
description: "The Skills Scoreboard renders a 7-entry arcade-style high-score table with blinking headers, animated rank indicators, and a coin-insert footer — used on the Skills page."
---
